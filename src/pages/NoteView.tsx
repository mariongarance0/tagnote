...
import { ArrowLeft, Trash2, X, Plus, Check, Cloud, CloudOff } from 'lucide-react';
...
const NoteView = () => {
  ...
  const {
    getNoteById, getLibraryById, getChildLibraries, getLibraryDepth,
    updateNote, deleteNote, addLibrary, tags,
  } = useNotes();
  ...
  }, [id, title, content, selectedTags, selectedLibrary, updateNote]);
      ...
      <div className="min-h-screen max-w-lg mx-auto">
        <div className="sticky top-0 z-10 glass-surface bg-background/90 px-4 py-3 flex items-center justify-between border-b border-border">
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={handleDelete} className="p-1 active:opacity-60" aria-label="Delete">
          ...
          <div className="flex items-center gap-2 mb-1">
            ...
            {library && (
              <>
                ...
                <span className="text-[12px] text-muted-foreground">{library.name}</span>
              </>
            )}
          </div>
